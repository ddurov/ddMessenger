...
public class messagesController extends RecyclerView.Adapter {
    ...
    public messagesController setMessageTextId(int messageTextId) {
        this.messageTextId = messageTextId;
        return this;
    }

    public messagesController setMessageTimeId(int messageTimeId) {
        this.messageTimeId = messageTimeId;
        return this;
    }

    public messagesController setOutgoingLayout(int outgoingLayout) {
        this.outgoingLayout = outgoingLayout;
        return this;
    }

    public messagesController setIncomingLayout(int incomingLayout) {
